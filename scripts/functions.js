...
endpoint.models.get = function(model, httpOptions) {
    ...
    sys.logs.debug('[whisper] GET from: ' + url);
	var options = checkHttpOptions(url, httpOptions);
	return endpoint._get(options);
};

endpoint.audio.transcriptions.post = function(httpOptions, callbackData, callbacks) {
    var url = parse('/v1/audio/transcriptions');
    sys.logs.debug('[whisper] POST from: ' + url);
    var options = checkHttpOptions(url, httpOptions);
    return endpoint._post(options, callbackData, callbacks);
};

endpoint.audio.translations.post = function(httpOptions, callbackData, callbacks) {
    var url = parse('/v1/audio/translations');
    sys.logs.debug('[whisper] POST from: ' + url);
    var options = checkHttpOptions(url, httpOptions);
    return endpoint._post(options, callbackData, callbacks);
};
